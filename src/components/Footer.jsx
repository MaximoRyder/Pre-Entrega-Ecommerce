...
const Footer = () => {
  return (
    <footer className="mt-auto border-t border-border bg-surface text-sub">
      <div className="max-w-screen-xl mx-auto px-4 sm:px-6 py-10 sm:py-12 grid gap-8 md:gap-10 md:grid-cols-3">
        <div className="space-y-3">
          <h3 className="text-primary-500 text-xl font-bold">Mi Tienda</h3>
          <p className="text-sm leading-relaxed text-muted">
            Tu tienda online de confianza con los mejores productos y precios.
          </p>
        </div>
        <div className="space-y-3">
          <h4 className="text-main text-base font-semibold">Navegación</h4>
          <ul className="flex flex-col gap-2 text-sm">
            <li>
              <Link className="hover:text-primary-500 transition-colors" to="/">
                Inicio
              </Link>
            </li>
            <li>
        ...
        <div className="space-y-3">
          <h4 className="text-main text-base font-semibold">Contacto</h4>
